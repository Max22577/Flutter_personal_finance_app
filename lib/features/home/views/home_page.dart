  ...
  void _onLogout(BuildContext context) async {
    ...
    if (context.mounted) {
      if (success) {
        ...
        AppFeedback.show(messenger, lang.translate('logout_successful'), colors: colors, textTheme: textTheme, isError: false);
      } else {
        AppFeedback.show(messenger, lang.translate('logout_failed'), colors: colors, textTheme: textTheme, isError: true);
      }
    }
  }
